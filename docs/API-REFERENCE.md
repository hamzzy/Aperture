...
**Metrics:** `buffer_utilization`, `push_error_rate`, `push_errors_total`, `clickhouse_flush_errors`, `clickhouse_pending_rows`, `event_throughput`
...
**Query parameters:**
- `event_type` — `cpu`, `lock`, `syscall` (optional)
- `limit` — max batches (default 100)
